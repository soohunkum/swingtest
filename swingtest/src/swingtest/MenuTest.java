...
public class MenuTest extends JFrame implements ActionListener, ItemListener{
		...
		public MenuTest() {
			...
			menu.addSeparator();
			cbMenuItem1 = new JCheckBoxMenuItem("체크 박스 메뉴 항목1");
			...
			public void actionPerformed(ActionEvent e) {
				if(e.getSource() == menuItem1) {
					JOptionPane.showMessageDialog(this, "메뉴항목1 이 선택되었습니다");
				}
			}
			
			public void itemStateChanged(ItemEvent e) {
				if(e.getSource() == cbMenuItem1) {
					JOptionPane.showMessageDialog(this, "체크 박스 메뉴 항목1 이 변경되었습니다");
				}
			}
